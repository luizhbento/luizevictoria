...
const Itinerario = () => {
  return (
    <div className=" bg-[#7A7E5E] p-5 max-w-[1400px] w-[100%] flex-col md:gap-6 lg:gap-10 md:flex-row md:px-10 flex items-center justify-around">
      ...
      <ol className="max-w-[800px] border-s border-white ">
        ...
        <li>
          ...
          <div className="mb-2 ms-4 mt-1">
            ...
            <p className="mb-3 text-neutral-300 ">
              Início do serviço de Drinks e abertura da boate com nossa primeira
              atração: pra felicidade dos paulistas, o grupo Sambafter traz o
              que temos de melhor do pagode e samba.
            </p>
          </div>
        </li>
        ...
        <li>
          ...
          <div className="mb-2 ms-4 mt-1">
            ...
            <p className="mb-3 text-neutral-300 ">
              Agora, pro agrado da turma do noivo, Gabriel Gadelha chega com um
              repertório variado: universitário, arrocha e, claro, modão. Canto,
              bebo e choro.
            </p>
          </div>
        </li>
        ...
        <li>
          ...
          <div className="mb-2 ms-4 mt-1">
            ...
            <p className="mb-3 text-neutral-300 ">
              Achou que já ia acabar né?! Pra fechar a noite (será?), teremos um
              DJ tocando aquele repertório que não pode faltar num casamento.
            </p>
          </div>
        </li>
      </ol>
